      ...
      <div className="workbench-grid">
        ...
        <aside className="card transform-panel">
          ...
          <div className="card-body">
            ...
            <div className="field"><label htmlFor="notes">관리자 메모</label><textarea id="notes" className="textarea notes-prompt" rows={3} value={notes} onChange={(event) => setNotes(event.target.value)} placeholder="출력물의 용도와 관리자가 알아둘 점을 적어주세요" /></div>
          ...
          <div className="card-body">
            ...
            <div className="field">
              ...
              <textarea
                ...
                placeholder="출력물의 용도와 관리자가 알아둘 점을 적어주세요"
              />
            </div>
            <button
    ...
    <div className="page">
      ...
      <div className="upload-grid">
        ...
        <section className="card upload-path">
          ...
          <div className="field"><label htmlFor="sliced-notes">관리자 메모</label><textarea id="sliced-notes" className="textarea notes-prompt" rows={3} value={notes} onChange={(event) => setNotes(event.target.value)} placeholder="출력물의 용도와 관리자가 알아둘 점을 적어주세요" /></div>
